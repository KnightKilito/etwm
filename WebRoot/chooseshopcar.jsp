	...
	<div class="page-wrapper">
		...
		<section class="testimonials_one three">
            ...
            <div class="block-title text-center">
                    <h4>Our Shops</h4>
                    <h2>Which One's Order You Wanna Check ?</h2>
			...
			<div class="container">
                        ...
                        <div class="latest_listings_three_single wow fadeInUp" data-wow-delay="0ms"
                            ...
                            <div class="latest_listings_three_image">
                                ...
                                <div class="author_img">
                                    <img src="assets/images/resources/latest_listings-3_au-img-1.png" alt="">
                                </div>
                            ...
                            <div class="latest_listings_three_content">
                                <div class="title">
                                    <h3><a href="showhistoryshopcar.ado?shopName=${shop.shopName }&username=${username}">${shop.shopName }<span
				...
				<center>
					<a href="allshopcar.ado?username=${username }&pageNum=1&pageSize=${pageSize}&search=${searchName}"
					class="btn btn-default">第一页 </a>
				<c:if test="${currPage!=1 }">
					<a href="allshopcar.ado?username=${username}&pageNum=${currPage-1 }&pageSize=${pageSize}&search=${searchName}"
				...
				<a href="allshopcar.ado?username=${username }&pageNum=${allPage}&pageSize=${pageSize}&search=${searchName}"
