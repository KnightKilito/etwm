			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-xl-4">
						...
						<div class="pricing_one_single wow fadeInUp animated"
							...
							<ul class="pricing_one_list list-unstyled">
								<li><i class="fa fa-check"></i>少女祈祷中...</li>
								<li><i class="fa fa-check"></i>您已挑选完毕...</li>
								<li><i class="fa fa-check"></i>总价计算完毕...</li>
								<li><i class="fa fa-check"></i>希望没有Bug！</li>

							</ul>
							<div class="pricing_one_btn">
								<!-- &addresseename=${user.realname}&phonenumber=${user.phone}&address=${user.address} -->
								<a href="alipay.ado?username=${username }&shopName=${shopName}"
									class="thm-btn">AliPay</a>
							</div>
							<br>
							<div class="pricing_one_btn">
								<a href="alipay.ado?username=${username }&shopName=${shopName}"
									class="thm-btn">WeChat Pay</a>
							</div>
							...
							<br>
							<div class="pricing_bottom_text">

								<a onclick="back()">继续“挑食”</a>
				...
				<div class="row">
					<div class="col-xl-6">
						...
						<div class="review_two_box_form">
							<h3 class="review_two_box_form__title">Address Message</h3>

							<form action="updateaddress.ado" class="review_two__form">
								<div class="row">
									<div class="col-xl-6">
										<div class="review_two_input_box">
											<input type="text" placeholder="Addressee Name" name="addresseename">
										</div>
									</div>
									<!-- <div class="col-xl-6">
								<div class="review_two_input_box">
								...
								<div class="row">
									<div class="col-xl-12">
										...
										<button type="submit" class="thm-btn review_from__btn">修改地址</button>
									</div>
								</div>
							</form>
						</div>
					</div>
					<!-- 展示信息 --><div class="col-xl-2"></div>
					<div class="col-xl-4">
						<!--Review Two Box Single-->

						<div class="review_two_box_form">
							<h3 class="review_two_box_form__title">收货信息</h3>
							...
							<div class="row">
								<div class="col-xl-12">
									<div class="review_two_input_box">
										<!-- <input type="text" placeholder="Your review title"
											name="Review Title"> -->
										<h1>${user.phone}</h1>
									</div>
								</div>
