	...
	<div class="page-wrapper">
		...
		<section class="testimonials_one three">
			...
			<div class="block-title text-center">
				<h4>Your ShopCar</h4>
				<h2>You Want Them ? Then Buy Them !</h2>
								...
								<div class="listings_two_page_content">
									...
									<div class="listings_two_page_single">
										<div class="listings_two_page_img">
											<img
												src="assets/images/resources/shopproducts/${shopName }/${shopProduct.productPicFile}"
												alt="">
										...
										<div class="listings_two-page_content">
											<div class="title">
												<h3>
													<a href="listings-details.html">${shopProduct.productName }<span
														class="fa fa-check"></span></a>
												</h3>
											</div>

											<div class="listings_two-page_content_bottom">
												<div class="left">
											...
											<div class="shopping_circle">
												<a href="deletefromcar.ado?shopId=${shop.id }&shopCarProductId=${shopProduct.shopCarProductId}" style="color: black"><span
													class="icon-shopping-bags"></span></a>
											</div>
										</div>
									</div>
			...
			<center>共 ${allCount } 条</center>
			<div class="banner_three_form_btn">
				<center>
					<a href="allshopproducts.do?shopId=${shop.id }&userId=${userId}"><button class="thm-btn" >继续“挑食”</button></a>
					<a href="countshopcar.ado?shopName=${shopName }&userId=${userId}"><button class="thm-btn" >立马下单</button></a>
				</center>
			</div>
		</section>
