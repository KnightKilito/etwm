	...
	<div class="page-wrapper">
		...
		<section class="testimonials_one three">
			...
			<div class="block-title text-center">
				<h4>Your ${shopName }'s History Order</h4>
				<h2>See What They Have Bought !</h2>

			</div>
			<c:forEach items="${list }" var="guestId">
				<!-- 按照guestId，orderId分组循环输出 -->
				<div class="container">

					<div class="row">
						<h3>${shopName }</h3>
						<c:forEach items="${list }" var="orderId">
							<div>
								<h3>${orderId.addressee }</h3>
							</div>
							<div>
								<h3>${orderId.phone }</h3>
							</div>
							<div>
								<h3>${orderId.address }</h3>
							</div>
							<!-- 循环输出产品信息 -->
							<c:forEach items="${list }" var="shopProduct">
								<%-- <c:if test="${shopProduct.shopCarOrderId }==orderId"> --%>
									<div class="col-xl-12">
										<div class="latest_listings_three_single wow fadeInUp"
											...
											<div class="listings_two_page_content">
												...
												<a href="deletfromcar.do" style="color: black"><span
			...
			<div class="banner_three_form_btn">
				<center>
					<button class="thm-btn" onclick="back()">返回</button>
				</center>
			</div>
		</section>
