...
<link href="https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/3.4.1/css/bootstrap.min.css" rel="stylesheet">
  ...
  <body>
  	<div class="container">
  	<h3>所有产品</h3>
  	<a href="turntoaddproduct.do?shopName=${shopName }" class="btn btn-success">新增产品</a>
  	<table class="table table-hover">
  		<c:forEach items="${list }" var="product">
  			<tr>
  				<td><img src="assets/images/resources/shopproducts/${shopName }/${product.productPicFile }" alt="" class="img-circle"></td>
  				<td>${product.productName }</td>
  				<td>${product.productPrice }</td>
  				<td>${product.productStar }</td>
  				
  				<td><a href="edt.do?id=${product.id }&shopName=${shopName }" class="btn btn-warning">编辑</a></td>
  				<td><a href="del.do?id=${product.id }&shopName=${shopName }" class="btn btn-success">删除</a></td>
  			</tr>
  		</c:forEach>
  	</table>
