			...
			<div class="container">
						...
						<div class="top_authors_single">
							<div class="top_authors_single_inner">
								<div class="top_authors_image">
									<img src="assets/images/resources/user/${user.picFile }" alt="">
								</div>
				...
				<center>
					<div class="food_lovers_two_btn">
						<a href="turntoupdate.ado?userId=${user.id }" class="thm-btn">修改信息</a>
					
						<a href="logout.ado?userId=${user.id }" class="thm-btn">登出账号</a>
					</div>
				</center>
			</div>
		</section>
