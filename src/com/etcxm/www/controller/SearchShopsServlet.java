 ...
 */
@WebServlet("/searchShop.do")
public class SearchShopsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SearchShopsServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("searchshops.jsp").forward(request, response);
	}
